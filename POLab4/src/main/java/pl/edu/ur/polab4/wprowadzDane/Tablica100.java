...
public class Tablica100 {
    ...
    public void menu(){
        ...
        while (menu !=0){
            System.out.println("1. Wprowadz dane studentów");
            System.out.println("2. Edycja danych studenta");
            System.out.println("3. Usunięcie danych studenta");
            System.out.println("4. Wyświetlenie danych jednego studenta");
            System.out.println("5. Wyświetlenie danych wszystkich studentów");
            System.out.println("6. Wyświetlene danych kilku studentów");
